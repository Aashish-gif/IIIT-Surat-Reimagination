...
interface IsometricHeatmapCardProps {
    isLoading?: boolean
...
export function IsometricHeatmapCard({ isLoading, data }: IsometricHeatmapCardProps) {
    // Generate mock data (24 weeks for better perspective)
    ...
    return (
        ...
        >
            <div className="flex items-center justify-between mb-8">
                <h3 className="text-lg font-semibold text-foreground">3D Contribution Skyline</h3>
                                ...
                                {week.map((day, dayIdx) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            {/* Right Side Face */}
                                            <div
                                                className="absolute bottom-0 left-full w-full h-full origin-left"
                                                style={{
                                                    height: `${height}px`,
                                                    width: `${height}px`,
                                            ...
                                            {/* Top Face */}
                                            <div
                                                className="absolute bottom-full left-0 w-full h-full origin-bottom"
                                                style={{
                                                    height: `${height}px`,
            ...
            <div className="mt-auto pt-6 border-t border-border/40">
                <div className="flex items-center gap-4">
                    ...
                    <div className="text-[10px] text-muted-foreground leading-tight">
                        Height = Commit Frequency<br />3D Isometric Projection
                    </div>
                </div>
            </div>
        </motion.div>
